...
namespace vix::middleware::observability
{
    ...
    inline std::string build_line_end(vix::middleware::Context &ctx,
    ...
    inline vix::middleware::Hooks debug_trace_hooks(std::shared_ptr<IDebugTraceSink> sink,
    ...
    inline vix::middleware::MiddlewareFn debug_trace_mw(std::shared_ptr<IDebugTraceSink> sink,
                                                        DebugTraceOptions opt = {})
    {
